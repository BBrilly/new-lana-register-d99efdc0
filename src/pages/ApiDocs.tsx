...
function getFreezeStatus(wTag) {
  ...
  const KNOWN_CODES = ["frozen_l8w", "frozen_max_cap", "frozen_too_wild", "frozen_unreg_Lanas", "frozen_lanapays_outdated", "frozen_retail_unallowed", "frozen_retail_over_limit", "frozen_own_threatening", "frozen_own_public_attack", "frozen_own_no_responsibility"];
  const code = wTag[6];
