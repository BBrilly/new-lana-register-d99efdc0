...
const UnregisteredDustPage = () => {
  const navigate = useNavigate();
  const { rows, isLoading, totalLana, count, sortField, sortDirection, toggleSort } = useUnregisteredLanaEvents(false);
      ...
      <div className="container mx-auto px-4 py-6">
        ...
        <Card className="p-4 sm:p-6">
          <UnregisteredLanaTable
            ...
            title="Dust Unregistered Lanas"
            subtitle="Events under the publish threshold — not broadcast as Kind 87003."
            emptyMessage="No dust unregistered Lana events."
...
export default UnregisteredDustPage;
